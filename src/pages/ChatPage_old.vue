<template>
  <q-page class="flex column bg-grey-1" style="height:100vh">
    <q-toolbar style="background-color: #2F2F2F; color: white;">
      <q-btn flat round dense icon="arrow_back" :to="'/chats_old'" />
    ...
    <div v-if="!chat" class="column items-center justify-center q-pa-xl">
      ...
      <q-btn class="q-mt-md" color="primary" label="back to chats" :to="'/chats_old'" />
    </div>
...
import { chats, me, type Member, type Message } from 'src/mock/chats_old'
